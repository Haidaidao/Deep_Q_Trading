...
class SpEnv(gym.Env):
    ...
    def __init__(self, minLimit=None, maxLimit=None, operationCost = 0, observationWindow = 20, ensamble = None, callback = None, isOnlyShort=False, columnName = "iteration-1"):
        ...
        #considering 8 weeks
        self.weekData = MergedDataStructure(delta=5,filename="./Output/ensemble/ensembleFolderWeek.csv")# this DS allows me to obtain previous historical data with different resolution
        self.dayData = MergedDataStructure(delta=5,filename="./Output/ensemble/ensembleFolderDay.csv")#  with low computational complexity
