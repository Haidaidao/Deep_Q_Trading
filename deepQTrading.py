...
class DeepQTrading:
    ...
    def run(self):
        ...
        for i in range(0, numFile):
            ...
            week = Trend(iteration = i, minLimit=trainMinLimit,maxLimit=trainMaxLimit, name = "Week" ,type = "train")
            week.writeFile()
            week = Trend(iteration = i, minLimit=validMinLimit,maxLimit=validMaxLimit, name = "Week" ,type = "valid")
            week.writeFile()
            week = Trend(iteration = i, minLimit=testMinLimit,maxLimit=testMaxLimit, name = "Week" ,type = "test")
            week.writeFile()
            ...
            day = Trend(iteration = i, minLimit=trainMinLimit,maxLimit=trainMaxLimit, name = "Day" ,type = "train")
            day.writeFile()
            day = Trend(iteration = i, minLimit=validMinLimit,maxLimit=validMaxLimit, name = "Day" ,type = "valid")
            day.writeFile()
            day = Trend(iteration = i, minLimit=testMinLimit,maxLimit=testMaxLimit, name = "Day" ,type = "test")
            day.writeFile()
