    ...
    for k in range(0,len(df1)):
        if(df1.index[k] in df2.index):
            if df1['ensemble'][k] == 0:
                ...
                if  getActionWeek(df3, df2.index[k]) == df2.loc[df1.index[k],'ensemble']:
                    ...
                    df.loc[df1.index[k]] = 0
                elif getActionWeek(df3, df2.index[k]) == df2.loc[df1.index[k],'ensemble'] and df2.loc[df1.index[k],'ensemble'] != df1['ensemble'][k]:
                    df.loc[df1.index[k]] = 0
                else:
                    df.loc[df1.index[k]] = 0
...
#         if perc == 0:
#             df1_result = perc_ensemble(df1_result, 0.9)
#         else:
